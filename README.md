    ...
    "results": [
        {
            ...
            "creation_date": "2021-09-22 09:35:00"
        },
        {
            ...
            "creation_date": "2021-09-01 20:35:00"
        },
        {
            ...
            "creation_date": "2021-03-30 10:40:00"
        },
        {
            ...
            "creation_date": "2021-05-18 16:35:00"
        },
        {
            ...
            "creation_date": "2021-08-19 12:31:00"
        },
        {
            ...
            "creation_date": "2021-08-27 20:00:00"
        },
        {
            ...
            "creation_date": "2021-09-22 12:25:00"
        },
        {
            ...
            "creation_date": "2021-09-24 02:41:00"
        },
        {
            ...
            "creation_date": "2021-09-17 15:52:00"
        },
        {
            ...
            "creation_date": "2021-09-17 15:59:00"
        }
    ]
}
```
...
### запрос
`
curl --location --request GET 'http://127.0.0.1:8000/api/v1/directories/?search=2021-09-03'
`
...
### запрос (успешный)
`
curl --location --request GET 'http://127.0.0.1:8000/api/v1/1.2.643.5.1.13.13.99.2.747/3 (3)/'
`
### ответ (успешный)
```json
{
...
### запрос (неуспешный)
`
curl --location --request GET 'http://127.0.0.1:8000/api/v1/1.2.643.5.1.13.13.99.2.747/333 (3)/'
`
### ответ (неуспешный)
```json
{
...
### запрос (успешный)
`
curl --location --request GET 'http://127.0.0.1:8000/api/v1/1.2.643.5.1.13.13.99.2.747/version/1.3/3 (3)/'
`
### ответ (успешный)
```json
{
...
### запрос (неуспешный)
`
curl --location --request GET 'http://127.0.0.1:8000/api/v1/1.2.643.5.1.13.13.99.2.747/version/1.3/333 (3)/'
`
### ответ (неуспешный)
```json
{
